...
const demoStops = [
  {
    icon: "🏕️",
    name: "Campground & day-use stop",
    description:
      "A future ROMI place card could show overnight details, water access, pet rules, hookups, and traveler notes all in one spot.",
    helpsWith: ["Sleep", "Water", "Power", "Dog Needs", "Adventure"],
    note: "Good for combining several road-life needs.",
  },
  {
    icon: "🛒",
    name: "Town essentials stop",
    description:
      "A future ROMI place card could combine groceries, fuel, laundry, showers, and practical supplies near one another.",
    helpsWith: ["Food", "Fuel", "Shower", "Laundry", "Water"],
    note: "Good for knocking out errands without extra driving.",
  },
  {
    icon: "📶",
    name: "Work & recharge stop",
    description:
      "A future ROMI place card could show simple Wi-Fi availability, cell-signal reports, outlets, parking, and honest traveler notes.",
    helpsWith: ["Wi‑Fi & Cell", "Power", "Food", "Shower"],
    note: "Good for remote-work or recharge days.",
  },
];
...
export default function Home() {
  ...
  }, [travelerReports, hasLoadedReports]);
        ...
        <section className="mx-auto max-w-md">
          ...
          <section className="mt-8">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600">
              These are demonstration cards for ROMI’s future matching system,
              not live Google results yet.
            </p>
